...
def leaveOneOutPrediction(params, experiment):
    ...
    y_pred_mode_all = []
    pred_err_mode = 0
    reconstruct = np.zeros(( experiment.ydim, experiment.T, experiment.numTrials )) * np.nan
    for tr in range(experiment.numTrials):
        ...
        for nrn in range(experiment.ydim):
            ...
            reconstruct[nrn, :, tr] = y_pred_mode_nrn
    ...
    return y_pred_mode, pred_err_mode, reconstruct
